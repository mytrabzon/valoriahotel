-- Bazı ortamlarda JWT'de is_anonymous gelmiyor; app_metadata / amr ile anonim misafir tespiti.
-- Ayrıca istemci her zaman p_device_install_id gönderir (202 sonrası).
...
COMMENT ON FUNCTION public.get_or_create_guest_for_caller(TEXT, TEXT) IS
  'Misafir getir/oluştur: JWT anonim (is_anonymous / app_metadata / amr) + p_device_install_id ile cihaz başına tek kayıt.';
