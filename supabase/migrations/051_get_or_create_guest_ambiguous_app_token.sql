-- 42702: "app_token" belirsiz — RETURNS TABLE(guest_id, app_token) çıktı parametreleri
-- INSERT ... RETURNING id, app_token içindeki app_token ile çakışıyor.
-- RETURNING'de sütunu tablo ile nitelendir: public.guests.app_token
...
COMMENT ON FUNCTION public.get_or_create_guest_for_caller(TEXT) IS
  'Çağıran kullanıcı için misafir; 051: RETURNING public.guests.app_token ile app_token belirsizlik hatası giderildi.';
